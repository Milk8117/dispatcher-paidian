...
(function() {
  ...
  var SOLAR_TERMS = [
    { name: '立春', date: '2月4日', season: 'spring', element: '木',
      ...
      foods: ['豆芽','韭菜','菠菜','蒜苗','春笋','荠菜','香椿','豌豆苗','马兰头','山药','红枣','莴笋'],
     忌: ['酸辣','油腻','生冷'],
    ...
    { name: '雨水', date: '2月18日', season: 'spring', element: '木',
      ...
      foods: ['菠菜','芹菜','莴笋','茼蒿','山药','红枣','蜂蜜','枇杷','荸荠','薏米','莲子','芋头'],
      忌: ['寒凉','甜腻'],
    ...
    { name: '惊蛰', date: '3月5日', season: 'spring', element: '木',
      ...
      foods: ['梨','芹菜','菠菜','韭菜','蒜苗','春笋','枇杷','桑葚','草莓','枸杞','菊花','莴笋'],
      忌: ['辛辣','烧烤'],
      tips: '起居有常，适当伸展，防春瘟',
      recipes: [
    ...
    { name: '春分', date: '3月20日', season: 'spring', element: '木',
      ...
      foods: ['菠菜','韭菜','春笋','香椿','草莓','桑葚','豌豆苗','樱桃','莴笋','百合','荠菜','枸杞'],
      忌: ['大寒大热'],
      tips: '运动适中，情志舒畅，防过敏',
      recipes: [
    ...
    { name: '清明', date: '4月5日', season: 'spring', element: '木',
      ...
      foods: ['青团','艾草','马兰头','春笋','荠菜','桑葚','樱桃','枇杷','蚕豆','枸杞芽','香椿','莴笋'],
      忌: ['辛辣燥热'],
    ...
    { name: '谷雨', date: '4月20日', season: 'spring', element: '土',
      ...
      foods: ['谷雨茶','香椿','枇杷','桑葚','樱桃','蚕豆','莴笋','黄瓜','薏仁','冬瓜','春笋','草莓'],
      忌: ['冰冷','甜腻'],
      tips: '预防春困，适度锻炼，注意防潮',
      recipes: [
    ...
    { name: '立夏', date: '5月5日', season: 'summer', element: '火',
      ...
      foods: ['蚕豆','苋菜','黄瓜','樱桃','荔枝','枇杷','杨梅','豌豆','蒜薹','莲子心','绿豆','西红柿'],
      忌: ['冰饮','辛辣'],
    ...
    { name: '小满', date: '5月21日', season: 'summer', element: '火',
      ...
      foods: ['苦瓜','黄瓜','番茄','茄子','四季豆','荔枝','杨梅','樱桃','芒果','西瓜','绿豆','桑葚'],
      忌: ['辛辣','烧烤'],
      tips: '穿着透气，饮食清淡，防皮肤病',
      recipes: [
    ...
    { name: '芒种', date: '6月5日', season: 'summer', element: '火',
      ...
      foods: ['杨梅','青梅','西瓜','荔枝','芒果','桃子','杏','冬瓜','荷叶','薏米','鸭肉','西红柿'],
      忌: ['油腻','生冷'],
    ...
    { name: '夏至', date: '6月21日', season: 'summer', element: '火',
      ...
      foods: ['西红柿','黄瓜','茄子','豆角','苦瓜','西瓜','桃子','荔枝','龙眼','荷叶','丝瓜','绿豆'],
      忌: ['大寒','冰镇'],
    ...
    { name: '小暑', date: '7月7日', season: 'summer', element: '火',
      ...
      foods: ['西红柿','黄瓜','豆角','苦瓜','丝瓜','冬瓜','西瓜','桃子','茄子','绿豆','荷叶','莲子'],
      忌: ['冰饮','烧烤'],
    ...
    { name: '大暑', date: '7月23日', season: 'summer', element: '火',
      ...
      foods: ['冬瓜','苦瓜','丝瓜','黄瓜','老鸭','薏米','绿豆','百合','莲子','秋葵','毛豆','西红柿','西瓜','桃','无花果','茄子','瓠子'],
    ...
    { name: '立秋', date: '8月7日', season: 'autumn', element: '金',
      ...
      foods: ['百合','银耳','梨','蜂蜜','莲藕','山药','葡萄','龙眼','桃子','无花果','南瓜','玉米'],
      忌: ['辛辣','燥热'],
      tips: '早卧早起，收敛神气，防秋燥' ,
      recipes: [
    ...
    { name: '处暑', date: '8月23日', season: 'autumn', element: '金',
      ...
      foods: ['百合','莲子','银耳','梨','蜂蜜','鸭子','葡萄','苹果','石榴','柚子','猕猴桃','鲜莲子'],
      忌: ['辛辣','生姜过量'],
    ...
    { name: '白露', date: '9月7日', season: 'autumn', element: '金',
      ...
      foods: ['梨','苹果','葡萄','大枣','核桃','龙眼','柚子','柿子','红薯','板栗','百合','银耳'],
      忌: ['寒凉','露脐'],
      tips: '添衣防凉，滋阴润肺，不露脐' ,
      recipes: [
    ...
    { name: '秋分', date: '9月23日', season: 'autumn', element: '金',
      ...
      foods: ['桂花','栗子','芋头','莲藕','百合','柿子','柚子','苹果','鸭肉','红薯','山楂','菱角'],
      忌: ['辛散','寒凉'],
      tips: '早睡早起，调畅情志，防悲秋' ,
      recipes: [
    ...
    { name: '寒露', date: '10月8日', season: 'autumn', element: '金',
      ...
      foods: ['芝麻','糯米','菊花','山楂','柿子','板栗','苹果','柚子','红薯','白萝卜','莲藕','百合'],
      忌: ['寒凉','生冷'],
      tips: '足部保暖，早卧早起，防感冒' ,
      recipes: [
        { name: '板栗烧鸡', method: '烧菜',
    ...
    { name: '霜降', date: '10月23日', season: 'autumn', element: '土',
      ...
      foods: ['柿子','栗子','牛肉','羊肉','萝卜','山药','白菜','红薯','苹果','柚子','莲藕','生姜'],
      忌: ['寒凉瓜果'],
      tips: '注意保暖，补益脾胃，迎冬准备' ,
      recipes: [
    ...
    { name: '立冬', date: '11月7日', season: 'winter', element: '水',
      ...
      foods: ['羊肉','牛肉','核桃','黑芝麻','栗子','萝卜','白菜','大葱','山药','红薯','柚子','苹果'],
      忌: ['寒凉','生冷'],
      tips: '早卧晚起，必待日光，防寒保暖' ,
      recipes: [
    ...
    { name: '小雪', date: '11月22日', season: 'winter', element: '水',
      ...
      foods: ['羊肉','牛肉','白菜','萝卜','大葱','土豆','红薯','栗子','生姜','红枣','山药','莲藕'],
      忌: ['寒凉','黏腻'],
    ...
    { name: '大雪', date: '12月7日', season: 'winter', element: '水',
      ...
      foods: ['羊肉','牛肉','白菜','萝卜','大葱','土豆','桂圆','核桃','红枣','生姜','山药','糯米'],
      忌: ['寒凉','冷饮'],
      tips: '早卧晚起，护好头颈，冬令进补' ,
      recipes: [
        { name: '当归生姜羊肉汤', method: '煲汤',
    ...
    { name: '冬至', date: '12月22日', season: 'winter', element: '水',
      ...
      foods: ['饺子','汤圆','羊肉','牛肉','萝卜','白菜','大葱','土豆','核桃','红枣','生姜','桂圆'],
      忌: ['寒凉','生冷'],
    ...
    { name: '小寒', date: '1月5日', season: 'winter', element: '水',
      ...
      foods: ['羊肉','牛肉','白菜','萝卜','大葱','土豆','核桃','黑芝麻','红枣','生姜','桂圆','山药'],
      忌: ['冰冷','寒性瓜果'],
      tips: '三九补冬，注意心脑血管保暖' ,
      recipes: [
    ...
    { name: '大寒', date: '1月20日', season: 'winter', element: '水',
      ...
      foods: ['八宝饭','羊肉','牛肉','白菜','萝卜','大葱','土豆','桂圆','核桃','红枣','生姜','糯米'],
      忌: ['寒凉','生冷'],
