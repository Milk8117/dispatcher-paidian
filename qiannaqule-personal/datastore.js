...
(function(global) {
  ...
  var WealthCT = {
    ...
    saveCashs: function(v) { DataStore.save(this.MODULE, 'cashs', v); },
    loadCashs: function() { return DataStore.load(this.MODULE, 'cashs', []); },
    saveLendings: function(v) { DataStore.save(this.MODULE, 'lendings', v); },
    loadLendings: function() { return DataStore.load(this.MODULE, 'lendings', []); },
    saveAssets: function(v) { DataStore.save(this.MODULE, 'assets', v); },
    loadAssets: function() { return DataStore.load(this.MODULE, 'assets', []); },
